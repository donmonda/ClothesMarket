    ...
    <footer className="bg-card border-t border-border">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <Link href="/" className="flex items-center gap-2">
              ...
              <span className="text-xl font-bold">NexusStore</span>
            </Link>
            <p className="text-muted-foreground text-sm">
              Tu destino para encontrar los mejores productos con la mejor calidad y precios competitivos.
            </p>
            <div className="flex gap-3">
              <Button variant="ghost" size="icon" className="h-9 w-9 rounded-full bg-muted hover:bg-primary hover:text-primary-foreground transition-colors" asChild>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/products?category=clothing" className="text-muted-foreground hover:text-primary transition-colors text-sm">
                  Ropa y Moda
                </Link>
              </li>
              <li>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-muted-foreground">
          <p>&copy; 2024 NexusStore. Todos los derechos reservados.</p>
